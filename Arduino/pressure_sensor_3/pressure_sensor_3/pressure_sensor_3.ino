...
void loop() {
  ...
  delay(10);
   ...
   pressure1 = (1.0 - 0.0)*(output - 1638.0)/13107.0 + 0.0;
   Serial.println(pressure1,DEC);
   ...
   pressure2 = (1.0 - 0.0)*(output - 1638.0)/13107.0 + 0.0;
   Serial.println(pressure2,DEC);
   
   digitalWrite(chipSelectPin2, HIGH);
   
   differential = abs(pressure2 - pressure1);
